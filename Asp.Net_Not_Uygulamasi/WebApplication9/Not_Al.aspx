...
TextColor|BGColor|SpecialChar" Height="312px"></CKEditor:CKEditorControl>
    ...
    <asp:Button ID="Button1" runat="server" Text="Vt-Kaydet" Height="30px" OnClick="Button1_Click" />
           ...
           <asp:Button ID="Button2" runat="server"  Text="Notu Mail At" Height="30px" OnClick="Button2_Click" />
               ...
               <tr>
                   <td class="auto-style18">
<asp:GridView ID="GridView1"  runat="server" CssClass="Gridview" AutoGenerateColumns="False" CellPadding="4" GridLines="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Width="304px" ForeColor="#333333" DataKeyNames="id" DataSourceID="SqlDataSource2">
