...
TextColor|BGColor|SpecialChar" Height="314px"></CKEditor:CKEditorControl>
        ...
        <asp:Button ID="Button1" runat="server"  Text="Güncelle" OnClick="Button1_Click" Height="30px" Font-Bold="True" />
            ...
            <tr>
                <td class="auto-style18">
        <asp:GridView ID="GridView1" runat="server" Height="151px" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" CellPadding="4" ForeColor="#333333" GridLines="None" Width="288px">
